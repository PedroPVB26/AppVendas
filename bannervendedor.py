...
class BannerVendedor(FloatLayout):
    ...
    def __init__(self, **kwargs):
        ...
        link = f'https://appvendashash-9c9fb-default-rtdb.firebaseio.com/.json?orderBy="id_vendedor"&equalTo="{id_vendedor}"'
        ...
        label_vendas = LabelButton(text=f"Total de vandas: R$ {total_vendas}", pos_hint={"right": 0.9, "top": 0.6}, size_hint=(0.5, 0.5),
                                   on_release=partial(meu_aplicativo.carregar_vendas_vendedor, valor))
